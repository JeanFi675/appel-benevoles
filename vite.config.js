  ...
  return {
    ...
    plugins: [
      createHtmlPlugin({
        minify: true,
        pages: [
          page('src/js/main.js', 'index.html', 'Bénévoles Escalade'),
          page('src/js/admin.js', 'admin.html', 'Administration - Bénévoles Escalade'),
          page('src/js/debit.js', 'debit.html', 'Paiement - Bénévoles'),
          page('src/js/scanner-tshirt.js', 'scanner-tshirt.html', 'Scanner T-Shirt - Bénévoles'),
          page(
            'src/js/admin-connexions.js',
            'admin-connexions.html',
            'Diagnostic Connexions - Bénévoles Escalade'
          ),
          page('src/js/besoins.js', 'besoins.html', 'Besoins Bénévoles - Escalade'),
        ],
      }),
    ],
    build: {
