...
export function adminBenevolesTab() {
    return {
        ...
        exportBenevolesExcel() {
            ...
            const headers = [
                'Nom', 'Prénom', 'Email', 'Téléphone', 'Taille T-shirt', 'Rôle',
                'Club (Type adhésion)', 'Inscriptions', 'Postes Référent',
                'Total Cagnotte Matériel (D)', 'Compte Principal Famille ?',
                'Consommé Global Famille (D)', 'Reste Global Famille (D)',
                'Cagnotte forcée ?', 'Créé le'
            ];
