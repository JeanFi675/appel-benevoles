...
export const CagnotteModule = {
    ...
    async getBalance() {
        ...
        try {
            const { data, error } = await ApiService.rpc('get_user_balance', { target_user_id: this.user.id });
        ...
        try {
            ...
            widget.innerHTML = `
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-emerald-600">${parseFloat(balance).toFixed(2)} €</div>
                    </div>
            ...
            btn.addEventListener('click', () => {
                ...
                if (isHidden) {
                    ...
                    const debitUrl = `${window.location.origin}/debit.html?id=${benevoleId}`;
