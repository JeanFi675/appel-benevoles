...
export const AdminModule = {
    ...
    // Cagnotte forcée → migré vers Alpine.data('adminCagnotteForceeTab') (Phase 5.2.5 / C5)

    // Bénévoles (state + modales + CRUD inscriptions/bénévoles + rôle)
    // → migré vers Alpine.data('adminBenevolesTab') (Phase 5.2.5 / C6)
    ...
    // Méthodes cagnotte forcée → migrées vers Alpine.data('adminCagnotteForceeTab')
    // (src/js/components/admin/admin-cagnotte-forcee-tab.js). Phase 5.2.5 / C5.
