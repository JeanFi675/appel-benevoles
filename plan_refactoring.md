...
- [ ] Tester une restauration partielle sur l'instance Supabase locale à partir d'un backup prod fraîchement téléchargé (issu de la GH Action). **DoD :** un compte-rendu est ajouté à `docs/disaster_recovery.md`.
