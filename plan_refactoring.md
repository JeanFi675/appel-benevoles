...
- [ ] Documenter la procédure de restauration dans `docs/disaster_recovery.md` (en actant : plan Free ⇒ pas de backup managé Supabase, la source de vérité est l'artefact chiffré de la GH Action). **DoD :** le fichier existe et inclut les commandes exactes (dump, déchiffrement gpg, restauration).
